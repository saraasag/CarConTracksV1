...
async function main() {
  ...
  //const CARRToken = await hre.ethers.getContractFactory("CARRToken");
  //const carrToken = await CARRToken.deploy(100000);

  await carRental.deployed();
  //await carrToken.deployed();

  console.log('CarRental deployed to:', carRental.address);
  //console.log("CARRToken deployed to:", carrToken.address);
