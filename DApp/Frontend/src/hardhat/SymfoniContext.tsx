...
import CarRentalDeployment from "./deployments/localhost/CarRental.json";
import { CarRental } from "./typechain/CarRental";
import { CarRental__factory } from "./typechain/factories/CarRental__factory";
...
export const CarRentalContext = React.createContext<SymfoniCarRental>(emptyContract);
...
export interface SymfoniCarRental {
    instance?: CarRental;
    factory?: CarRental__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [CarRental, setCarRental] = useState<SymfoniCarRental>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setCarRental(getCarRental(_provider, _signer))
                finish(text)
            }
    ...
    const getCarRental = (_provider: providers.Provider, _signer?: Signer) => {

        const contractAddress = CarRentalDeployment.receipt.contractAddress
        const instance = _signer ? CarRental__factory.connect(contractAddress, _signer) : CarRental__factory.connect(contractAddress, _provider)
        const contract: SymfoniCarRental = {
            instance: instance,
            factory: _signer ? new CarRental__factory(_signer) : undefined,
        }
        return contract
    }
        ;
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <CarRentalContext.Provider value={CarRental}>
                            {showLoading && loading ?
